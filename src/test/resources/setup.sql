...
VALUES (1, 'Février 2011'),
       ...
       (3, 'Avril 2011'),
       (4, 'Février 2012');
ALTER TABLE `newro-factory-db`.promotion
...
ALTER TABLE `newro-factory-db`.intern
    ALTER COLUMN id RESTART WITH 51;

INSERT INTO `newro-factory-db`.chapter (id, name, parent_path)
VALUES (5, 'OCA', '/');
ALTER TABLE `newro-factory-db`.chapter
...
ALTER TABLE `newro-factory-db`.question
    ALTER COLUMN id RESTART WITH 404;
...
ALTER TABLE `newro-factory-db`.answer
    ALTER COLUMN id RESTART WITH 227;
