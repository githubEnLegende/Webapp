            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>
                            <a href="dashboard?page=${requestScope.page}&size=${size}&order=arrival&search=${search}">Id</a>
                        </th>
                        <!-- Table header for Discontinued Date -->
                        <th>
                            <a href="dashboard?page=${requestScope.page}&size=${size}&order=formation_over&search=${search}">Name</a>
                        </th>
                        <!-- Table header for Company -->
                        <th>
                            <a href="dashboard?page=${requestScope.page}&size=${size}&order=promotion_id&search=${search}">Path</a>
                        </th>
