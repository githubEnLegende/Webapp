...
//
////    private static final ApplicationContext context = Context.getInstance().getContext();
////    private static final UtilitairesDAO utilitairesDAO = context.getBean(UtilitairesDAO.class);
////    private static final StagiaireDAO stagiaireDAO = context.getBean(StagiaireDAO.class);
////    private static final PromotionDAO promotionDAO = context.getBean(PromotionDAO.class);
////    private static final QuestionDAO questionDAO = context.getBean(QuestionDAO.class);
//
