...
VALUES  (3, 'A', 'cars', 0, 364),
        ...
        (137, 'A', 'If the file does not contain a package statement, then the compiler considers the class part of the java.lang package.', 0, 388),
        ...
        (142, 'F', 'If the class declaration does not extend another class, then it implicitly extends the java.lang.Object class.', 1, 388),
        (143, 'A', 'Grow!', 0, 389),
        (144, 'B', 'Growing!', 0, 389),
        ...
        (189, 'B', 'Inheritance allows a method to be overridden in a subclass, possibly changing the expected behavior of other methods in a superclass', 1, 397),
